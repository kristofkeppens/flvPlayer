...
(function()
{
    ...
    var onSizeChange = function()
    {
        ...
        if ( dialog.lockRatio )
        {
            ...
            {
                if ( value && value != '0' )
                    value = Math.round( CKEDITOR.config.flvPlayer.width * ( value  / CKEDITOR.config.flvPlayer.height ) );
                if ( !isNaN( value ) )
            ...
            {
                if ( value && value != '0' )
                    value = Math.round( CKEDITOR.config.flvPlayer.height * ( value  / CKEDITOR.config.flvPlayer.width ) );
                if ( !isNaN( value ) )
    ...
    var switchLockRatio = function( dialog, value )
    {
        ...
        if ( value == 'check' )         // Check image ratio and original image ratio.
            {
                var width = dialog.getValueOf( 'info', 'width' ),
                    ...
                    originalRatio = CKEDITOR.config.flvPlayer.width * 1000 / CKEDITOR.config.flvPlayer.height,
        ...
        var lang = dialog._.editor.lang.flvPlayer,
    ...
    var resetSize = function( dialog )
    {
        ...
        dialog.setValueOf( 'info', 'width', CKEDITOR.config.flvPlayer.width );
        dialog.setValueOf( 'info', 'height', CKEDITOR.config.flvPlayer.height );
                ...
                case ATTRTYPE_OBJECT:
                    ...
                    if ( isRemove || isCheckbox && value === attrDef[ 'default' ] )
                        ...
                        if(attrDef.name == 'flashvars')
                        {
                            ...
                            value = 'config={"clip":{"url":"' + escape( value ) + '", "autoPlay":false}'+ CKEDITOR.config.flvPlayer.extraFlashVars +'}';
    ...
    CKEDITOR.dialog.add( 'flvPlayer', function( editor )
    {
        ...
        var previewPreloader,
            ...
            '<div id="FlashPreviewLoader" style="display:none"><div class="loading">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae,' 
            ...
            '<div id="FlashPreviewBox">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae,' 
            +'nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.</div></div>';

        return {
            title : editor.lang.flvPlayer.title,
            minWidth : 420,
            minHeight : 310,
            onShow : function()
            {
                ...
                if ( !this.fakeImage )
                {
                    if ( makeObjectTag )
                    {
                        ...
                        var attributes = {
                            ...
                            movie : CKEDITOR.config.flvPlayer.movie,
                            id : 'flowplayer'
                        ...
                        embedNode.setAttributes(
                            {
                                ...
                                src : CKEDITOR.config.flvPlayer.movie
                            } );
                        if ( objectNode )
                            ...
                            [
                {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            onLoad : function()
                            {
                                ...
                                if ( ratioButton )
                                {
                                    ratioButton.on( 'click', function(evt)
                                    {
                                        ...
                                        if ( width )
                                        {
                                            var height = CKEDITOR.config.flvPlayer.height / CKEDITOR.config.flvPlayer.width * width;
                                            if ( !isNaN( height ) )
                                            {
                            ...
                            html : '<div>'+
                            '<a href="javascript:void(0)" tabindex="-1" title="' + editor.lang.flvPlayer.unlockRatio +
                            '" class="cke_btn_locked" id="btnLockSizes" role="button"><span class="cke_label">' + editor.lang.flvPlayer.unlockRatio + '</span></a>' +
                            '<a href="javascript:void(0)" tabindex="-1" title="' + editor.lang.flvPlayer.resetSize +
                            '" class="cke_btn_reset" id="btnResetSize" role="button"><span class="cke_label">' + editor.lang.flvPlayer.resetSize + '</span></a>'+
                            '</div>'
                        }
                    ]
                },
